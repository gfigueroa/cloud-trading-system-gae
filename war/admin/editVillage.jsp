...
String villageKey = request.getParameter("k");
Village village = VillageManager.getVillage(KeyFactory.stringToKey(villageKey));

District district = DistrictManager.getDistrict(village.getKey().getParent());
%>
...
<div id="content_area">
<div class="title_bar title_name">編輯村里</div>
	<form id="addVillageform" name="addVillageform" method="post" action="/manageGlobalObject?action=update&type=village&k=<%= villageKey %>">
  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td height="73" colspan="2" align="right" class="form_underline" scope="row">請輸入欲編輯的村里資料：</td>
    ...
    <tr>
      ...
      <td width="354" height="60">
        <input name="districtId" type="text" class="textfield_style" id="districtId" value="<%= district.getDistrictName() %>" disabled></td>
    </tr>
    <tr>
      <td width="130" height="60" align="right" scope="row">&nbsp;</td>
      <td height="60" align="right" scope="row"><label for="villageName">*村里名稱：</label></td>
      <td width="354" height="60">
        <input name="villageName" type="text" class="textfield_style" id="villageName" value="<%= village.getVillageName() %>"></td>
