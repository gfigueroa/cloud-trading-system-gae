...
String serviceTypeKey = request.getParameter("k");
ServiceType serviceType = ServiceTypeManager.getServiceType(Long.parseLong(serviceTypeKey));
%>
...
<div id="content_area">
<div class="title_bar title_name">編輯義工類別</div>
	<form id="addServiceTypeform" name="addServiceTypeform" method="post" action="/manageGlobalObject?action=update&type=serviceType&k=<%= serviceTypeKey %>">
  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td height="73" colspan="2" align="right" class="form_underline" scope="row">請輸入欲編輯的義工類別資料：</td>
    ...
    <tr>
      ...
      <td width="354" height="60">
        <input name="serviceTypeName" type="text" class="textfield_style" id="serviceTypeName" value="<%= serviceType.getServiceTypeName() %>"></td>
