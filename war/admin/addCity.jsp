...
<div id="content_area">
<div class="title_bar title_name">新增城市</div>
	<form id="addCityform" name="addCityform" method="post" action="/manageGlobalObject?action=add&type=city&keep_adding=true">
  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td height="73" align="right" class="form_underline" scope="row">&nbsp;</td>
      <td width="265" height="73" align="right" class="form_underline" scope="row">請填入城市名稱：</td>
    ...
    <tr>
      ...
      <td class="form_underline" width="411" height="120">
        <input name="cityName" type="text" class="textfield_style" id="cityName">
        </td>
      <td class="form_underline" width="189" height="120"><div id="empty_CityName" class="errorText">*Enter city name</div></td>
    </tr>
    <tr>
      <td></td>
