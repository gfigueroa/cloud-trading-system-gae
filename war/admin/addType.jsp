...
<div id="content_area">
<div class="title_bar title_name">新增物品類別</div>
	<form id="addItemTypeform" name="addItemTypeform" method="post" action="/manageGlobalObject?action=add&type=itemType&keep_adding=true">
  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td height="73" colspan="2" align="right" class="form_underline" scope="row">請輸入欲新增的物品類別資料：</td>
    ...
    <tr>
	  ...
	  %>
	  	  <option value="<%= itemCategory.getKey() %>"><%= itemCategory.getItemCategoryName() %></option>
	  <%
	  }
	  %>
	  </select></td>
    ...
    <tr>
      ...
      <td width="354" height="60">
        <input name="itemTypeName" type="text" class="textfield_style" id="itemTypeName"></td>
