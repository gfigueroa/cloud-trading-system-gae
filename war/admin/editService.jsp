...
String serviceKeyString = request.getParameter("k");
Key serviceKey = KeyFactory.stringToKey(serviceKeyString);
Service service = ServiceManager.getService(serviceKey);

ServiceType thisServiceType = ServiceTypeManager.getServiceType(service.getServiceType());
List<ServiceType> serviceTypes = ServiceTypeManager.getAllServiceTypes();

Customer customer = CustomerManager.getCustomer(service.getCustomerKey());
%>
...
<div id="content_area">
<div class="title_bar title_name">編輯義工</div>
	<form id="addStorageform" name="addStorageform" method="post" action="/manageCustomer?k=<%= serviceKeyString %>&action=update&type=service">
  
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td width="282" height="73" align="right" class="form_underline" scope="row">&nbsp;</td>
      <td height="73" colspan="3" align="left" class="form_underline" scope="row">請輸入欲修改的義工資料：</td>
    ...
    <tr>
      ...
      <td height="60" colspan="2">
        <input type="text" name="serviceDescription" class="textfield_style" id="serviceDescription" value="<%= service.getServiceDescription() %>"></td>
      <td width="54" height="60">&nbsp;</td>
	</tr>
    </table>
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="1">
