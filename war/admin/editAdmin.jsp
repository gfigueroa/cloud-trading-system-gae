...
<div id="content_area">
<div class="title_bar title_name">編輯管理者</div>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      ...
      <td height="60" colspan="2" align="left" class="form_underline" scope="row">欲修改的管理者資訊:
        <%
String msg = request.getParameter("msg");
String action = request.getParameter("action");
if (msg != null && msg.equalsIgnoreCase("success") && action != null && action.equals("update")) {
%>
        <span class="warn_font_green">編輯成功 !</span>
        <% } 
...
%></td>
    ...
    <tr>
      ...
      <td height="50" align="right" scope="row">*使用者類別：</td>
    ...
    <tr>
      ...
      <% if(sessionUser.getUserType() == User.UserType.ADMINISTRATOR){ %>
      <a class="changePasswordStyle" href="#" onclick="window.open(' editAdminPassword.jsp?k=<%= userKey %>', 'Change Password', config='height=752,width=1112px');">變更密碼</a>
      <% } %>
      </td>
      <td height="50"></td>
    </tr>
