...
String itemCategoryKey = request.getParameter("k");
ItemCategory itemCategory = ItemCategoryManager.getItemCategory(Long.parseLong(itemCategoryKey));
%>
...
<div id="content_area">
<div class="title_bar title_name">編輯目錄</div>
	<form id="addItemCategoryform" name="addItemCategoryform" method="post" action="/manageGlobalObject?action=update&type=itemCategory&k=<%= itemCategoryKey %>">
  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td height="73" colspan="2" align="right" class="form_underline" scope="row">請輸入欲編輯的目錄資料：</td>
    ...
    <tr>
      ...
      <td width="354" height="60">
        <input name="itemCategoryName" type="text" class="textfield_style" id="itemCategoryName" value="<%= itemCategory.getItemCategoryName() %>"></td>
