...
public class ManageUserServlet extends HttpServlet {
    ...
    private BlobKey addOrUpdateCustomer(HttpServletRequest req, User user,
		...
		String customerIdentityNumber = req.getParameter("customerIdentityNumber");
		String customerNickname = req.getParameter("customerNickname");
		String customerSerialNumber = req.getParameter("customerSerialNumber");
		...
		String villageIdString = req.getParameter("villageId");
		Key villageId = null;
		if (villageIdString != null) {
		    if (!villageIdString.isEmpty()) {
		    	villageId = KeyFactory.stringToKey(villageIdString);
			}
		}
		// regionIdString will be null if the Customer is updating
		else {
			villageId = customerToUpdate.getVillage();
		}
